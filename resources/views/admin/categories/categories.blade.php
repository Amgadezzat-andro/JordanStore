                        ...
                        <div class="col-md-3">
                            <div class="alert alert-primary" role="alert">
                                <span class="button-span">
                                    ...
                                    <span>
                                        <a class="edit-unit" data-categoryname="{{ $category->name }}" data-categoryid="{{ $category->id }}">
                                    ...
                                    <span>
                                        <a class="delete-unit" data-categoryname="{{ $category->name }}" data-categoryid="{{ $category->id }}">
